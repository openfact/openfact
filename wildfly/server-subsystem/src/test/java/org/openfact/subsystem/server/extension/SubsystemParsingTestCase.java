...
public class SubsystemParsingTestCase extends AbstractSubsystemBaseTest {
    ...
    public SubsystemParsingTestCase() {
        super(OpenfactExtension.SUBSYSTEM_NAME, new OpenfactExtension());
    }
    ...
    protected Properties getResolvedProperties() {
        ...
        properties.put("openfact.jta.lookup.provider", "jboss");
        return properties;
    }
    
    @Override
    protected String getSubsystemXml() throws IOException {
        return readResource("openfact-server-1.1.xml");
    }

    @Override
    protected String getSubsystemXsdPath() throws Exception {
        return "schema/wildfly-openfact-server_1_1.xsd";
    }

    @Override
    protected String[] getSubsystemTemplatePaths() throws IOException {
        return new String[]{
            "/subsystem-templates/openfact-server.xml"
        };
    }
}
