 ...
 * @version $Revision: 1 $
 */
public class OpenfactProviderDeploymentProcessor implements DeploymentUnitProcessor {

    AttachmentKey<ProviderManager> ATTACHMENT_KEY = AttachmentKey.create(ProviderManager.class);

    private static final Logger logger = Logger.getLogger(OpenfactProviderDeploymentProcessor.class);
    @Override
    ...
    public OpenfactProviderDeploymentProcessor() {
        super();
    }
