...
public final class OpenfactSubsystemRemoveHandler extends ReloadRequiredRemoveStepHandler {
    ...
    static OpenfactSubsystemRemoveHandler INSTANCE = new OpenfactSubsystemRemoveHandler();

    private OpenfactSubsystemRemoveHandler() {}

    @Override
    protected void performRemove(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        String deploymentName = ServerUtil.getDeploymentName(operation);
        OpenfactAdapterConfigService.INSTANCE.setWebContext(null);
