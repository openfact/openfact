...
public abstract class AbstractRsaKeyProvider implements RsaKeyProvider {
    ...
    public AbstractRsaKeyProvider(CompanyModel organization, ComponentModel model) {
        this.model = model;
    ...
    protected abstract Keys loadKeys(CompanyModel organization, ComponentModel model);
