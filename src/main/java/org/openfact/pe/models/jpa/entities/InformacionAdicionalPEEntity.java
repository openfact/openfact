...
public class InformacionAdicionalPEEntity implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof InformacionAdicionalPEEntity)) {
            return false;
        }
        InformacionAdicionalPEEntity other = (InformacionAdicionalPEEntity) obj;
        if (id != null) {
