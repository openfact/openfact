 ...
 * 2018-04-10T15:59:49.719-05:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "billService",
                  wsdlLocation = "file:/home/admin/git/openfact/src/main/resources/wsdl/retencion_percepcion.wsdl",
...
public class BillService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/admin/git/openfact/src/main/resources/wsdl/retencion_percepcion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BillService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/admin/git/openfact/src/main/resources/wsdl/retencion_percepcion.wsdl");
        }
        WSDL_LOCATION = url;
    }
