 ...
 * 2018-04-10T16:25:47.206-05:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "billConsultService",
                  wsdlLocation = "file:/home/admin/git/openfact/src/main/resources/wsdl/consulta_cdr.wsdl",
...
public class BillConsultService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/admin/git/openfact/src/main/resources/wsdl/consulta_cdr.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BillConsultService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/admin/git/openfact/src/main/resources/wsdl/consulta_cdr.wsdl");
        }
        WSDL_LOCATION = url;
    }
