 ...
 * @version $Revision: 1 $
 */
public class CachedInvoice extends AbstractExtendableRevisioned implements InOrganization {

    public CachedInvoice(Long revision, OrganizationModel organization, InvoiceModel invoice) {
        super(revision, invoice.getId());
