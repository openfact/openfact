 ...
 */
@Listener
public class CreditNoteCacheManager extends CacheManager {

    protected static final Logger logger = Logger.getLogger(CreditNoteCacheManager.class);

    protected volatile boolean enabled = true;

    public CreditNoteCacheManager(Cache<String, Revisioned> cache, Cache<String, Long> revisions) {
