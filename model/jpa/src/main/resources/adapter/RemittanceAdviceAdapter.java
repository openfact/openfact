 ...
 */
public class RemittanceAdviceAdapter{
	...
	/**
	 * The total payable amount for the RemittanceAdviceAdapter (must be positive).
	 */
	...
	private List<RemittanceAdviceLineAdapter> remittanceAdviceLines = new ArrayList<>(); 
