...
public class ConsignmentAdapter{
	...
	private AllowanceChargeAdapter extraAllowanceCharge; 
	private AllowanceChargeAdapter freightAllowanceCharge; 
	private ContractAdapter transportContract; 
	private CountryAdapter originalDepartureCountry; 
	private CountryAdapter finalDestinationCountry; 
	private CountryAdapter transitCountry; 
	...
	private PartyAdapter billOfLadingHolderParty; 
	private PartyAdapter freightForwarderParty; 
	private PartyAdapter insuranceParty; 
	private PartyAdapter originalDespatchParty; 
	...
	private PartyAdapter consigneeParty; 
	private ConsignmentAdapter childConsignment; 
	private PartyAdapter logisticsOperatorParty; 
	private PartyAdapter mortgageHolderParty; 
	private PartyAdapter hazardousItemNotificationParty; 
	private PartyAdapter transportAdvisorParty; 
	private PartyAdapter substituteCarrierParty; 
	private PartyAdapter performingCarrierParty; 
	private PartyAdapter finalDeliveryParty; 
	private List<PaymentTermsAdapter> collectPaymentTerms = new ArrayList<>(); 
	private List<PaymentTermsAdapter> disbursementPaymentTerms = new ArrayList<>(); 
	private List<PaymentTermsAdapter> prepaidPaymentTerms = new ArrayList<>(); 
	private List<PaymentTermsAdapter> paymentTermses = new ArrayList<>(); 
	private ShipmentAdapter consolidatedShipment; 
	private ShipmentStageAdapter onCarriageShipmentStage; 
	private ShipmentStageAdapter preCarriageShipmentStage; 
	private ShipmentStageAdapter mainCarriageShipmentStage; 
	...
	private TransportationServiceAdapter originalDespatchTransportationService; 
	private TransportationServiceAdapter finalDeliveryTransportationService; 
	private List<StatusAdapter> statuses = new ArrayList<>(); 
	private List<TransportEventAdapter> requestedPickupTransportEvent = new ArrayList<>(); 
	private List<TransportEventAdapter> requestedDeliveryTransportEvent = new ArrayList<>(); 
	private List<TransportEventAdapter> plannedPickupTransportEvent = new ArrayList<>(); 
	private List<TransportEventAdapter> plannedDeliveryTransportEvent = new ArrayList<>(); 
