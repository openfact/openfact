...
public class Quotation {
	...
	private Document Reference Request For Quotation Document Reference;
	private Monetary Total Quoted Monetary Total;
	private Payment Means m_Payment Means;
	private Period Validity Period;
	private Quotation Line m_Quotation Line;
	...
	public Quotation Line getQuotation Line(){
		return m_Quotation Line;
	}

	public Monetary Total getQuoted Monetary Total(){
		return Quoted Monetary Total;
	}

	public Document Reference getRequest For Quotation Document Reference(){
	 ...
	 * @param newVal
	 */
	public void setQuotation Line(Quotation Line newVal){
	 ...
	 * @param newVal
	 */
	public void setQuoted Monetary Total(Monetary Total newVal){
	 ...
	 * @param newVal
	 */
	public void setRequest For Quotation Document Reference(Document Reference newVal){
