...
public class Despatch {
	...
	private Period Requested Despatch Period;
	private Period Estimated Despatch Period;
	...
	public Address getDespatch Address(){
		return Despatch Address;
	}

	public Location getDespatch Location(){
		return Despatch Location;
	}

	public Party getDespatch Party(){
		return Despatch Party;
	}

	public Period getEstimated Despatch Period(){
	...
	public Period getRequested Despatch Period(){
	 ...
	 * @param newVal
	 */
	public void setDespatch Address(Address newVal){
	 ...
	 * @param newVal
	 */
	public void setDespatch Location(Location newVal){
	 ...
	 * @param newVal
	 */
	public void setDespatch Party(Party newVal){
	 ...
	 * @param newVal
	 */
	public void setEstimated Despatch Period(Period newVal){
	 ...
	 * @param newVal
	 */
	public void setRequested Despatch Period(Period newVal){
