...
public class Tender {
	...
	private Document Reference Tenderer Qualification Document Reference;
	private Party Subcontractor Party;
	private Party Tenderer Party;
	private Period Validity Period;
	private Signature m_Signature;
	private Tendered Project m_Tendered Project;
	...
	public Party getSubcontractor Party(){
		return Subcontractor Party;
	}

	public Tendered Project getTendered Project(){
		return m_Tendered Project;
	}

	public Party getTenderer Party(){
		return Tenderer Party;
	}

	public Document Reference getTenderer Qualification Document Reference(){
	 ...
	 * @param newVal
	 */
	public void setSubcontractor Party(Party newVal){
	 ...
	 * @param newVal
	 */
	public void setTendered Project(Tendered Project newVal){
	 ...
	 * @param newVal
	 */
	public void setTenderer Party(Party newVal){
	 ...
	 * @param newVal
	 */
	public void setTenderer Qualification Document Reference(Document Reference newVal){
