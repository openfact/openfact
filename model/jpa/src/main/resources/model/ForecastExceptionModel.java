...
/**
 * As explained in ExceptionCriteriaModel Line: Three types of exception criteria can
...
public class ForecastExceptionModel{
	...
	/**
	 * It is either Sales forecast or OrderModel Forecast. Definition can be changed like:
	 * "The purpose of the ForecastModel (either sales or order), about which an exception
