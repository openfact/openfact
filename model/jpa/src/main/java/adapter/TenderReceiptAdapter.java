 ...
 */
public class TenderReceiptAdapter{
	...
	/**
	 * The date, assigned by the sender, on which the TenderReceiptAdapter was created.
	 */
	private DateType RegisteredDate;
	/**
	 * The time, assigned by the sender, at which the TenderReceiptAdapter was created.
	 */
	...
	private DocumentReferenceAdapter TenderDocumentReference;
