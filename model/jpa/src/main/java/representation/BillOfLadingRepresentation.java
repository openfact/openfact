...
public class BillOfLadingRepresentation{
	...
	/**
	 * A code signifying the status of the BillOfLadingRepresentation (revision, replacement, etc.
	 * ).
	 */
	...
	/**
	 * Reference number to identify a Shipping OrderRepresentation or Forwarding Instruction.
	 */
