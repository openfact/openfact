...
public class CatalogueDeletionEntity{
	...
	/**
	 * The effective date, assigned by the seller, on which the CatalogueEntity expires.
	 */
	private DateType effectiveDate; 
	/**
	 * The effective time, assigned by the seller, at which the CatalogueEntity expires.
	 */
