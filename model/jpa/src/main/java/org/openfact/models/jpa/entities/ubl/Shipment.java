...
public class Shipment {
	...
	/**
	 * @param consignmentQuantity the consignmentQuantity to set
	 */
	...
	/**
	 * @param declaredCustomsValueAmount the declaredCustomsValueAmount to set
	 */
	...
	/**
	 * @param declaredForCarriageValueAmount the declaredForCarriageValueAmount to set
	 */
	...
	/**
	 * @param declaredStatisticsValueAmount the declaredStatisticsValueAmount to set
	 */
	...
	/**
	 * @param freeOnBoardValueAmount the freeOnBoardValueAmount to set
	 */
	...
	/**
	 * @param grossVolumeMeasure the grossVolumeMeasure to set
	 */
	...
	/**
	 * @param grossWeightMeasure the grossWeightMeasure to set
	 */
	...
	/**
	 * @param handlingCode the handlingCode to set
	 */
	...
	/**
	 * @param insuranceValueAmount the insuranceValueAmount to set
	 */
	...
	/**
	 * @param netNetWeightMeasure the netNetWeightMeasure to set
	 */
	...
	/**
	 * @param netVolumeMeasure the netVolumeMeasure to set
	 */
	...
	/**
	 * @param netWeightMeasure the netWeightMeasure to set
	 */
	...
	/**
	 * @param shippingPriorityLevelCode the shippingPriorityLevelCode to set
	 */
	...
	/**
	 * @param splitConsignmentIndicator the splitConsignmentIndicator to set
	 */
	...
	/**
	 * @param totalGoodsItemQuantity the totalGoodsItemQuantity to set
	 */
	...
	/**
	 * @param totalTransportHandlingUnitQuantity the totalTransportHandlingUnitQuantity to set
	 */
	...
	/**
	 * @param freightAllowanceCharge the freightAllowanceCharge to set
	 */
	...
	/**
	 * @param m_Consignment the m_Consignment to set
	 */
	...
	/**
	 * @param exportCountry the exportCountry to set
	 */
	...
	/**
	 * @param m_Delivery the m_Delivery to set
	 */
	...
	/**
	 * @param m_GoodsItem the m_GoodsItem to set
	 */
	...
	/**
	 * @param lastExitPortLocation the lastExitPortLocation to set
	 */
	...
	/**
	 * @param firstArrivalPortLocation the firstArrivalPortLocation to set
	 */
	...
	/**
	 * @param m_ShipmentStage the m_ShipmentStage to set
	 */
	...
	/**
	 * @param m_TransportHandlingUnit the m_TransportHandlingUnit to set
	 */
