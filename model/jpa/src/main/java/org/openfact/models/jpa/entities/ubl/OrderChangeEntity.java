...
public class OrderChangeEntity{
	...
	/**
	 * The buyer's accounting code, applied to the OrderChangeEntity as a whole, expressed
	 * as text.
	 */
	...
	/**
	 * The OrderChangeEntity Sequence Number assigned by the Buyer to ensure the proper
