...
/**
 * A document used by a ContractingPartyEntity to define a procurement project to buy
...
public class CallForTendersEntity{
	...
	/**
	 * The date, assigned by the contracting party, on which the CallForTendersEntity was
	 * approved.
	 */
