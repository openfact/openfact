...
public class Meter {
	...
	private Meter Property m_Meter Property;
	private Meter Reading m_Meter Reading;
	...
	public Meter Property getMeter Property(){
		return m_Meter Property;
	}

	public Meter Reading getMeter Reading(){
	 ...
	 * @param newVal
	 */
	public void setMeter Property(Meter Property newVal){
	 ...
	 * @param newVal
	 */
	public void setMeter Reading(Meter Reading newVal){
