...
public class TenderReceiptEntity{
	...
	/**
	 * The date, assigned by the sender, on which the TenderReceiptEntity was created.
	 */
	private DateType registeredDate; 
	/**
	 * The time, assigned by the sender, at which the TenderReceiptEntity was created.
	 */
