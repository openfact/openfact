 ...
 * creditor; SelfBilledCreditNoteEntity replaces DebitNoteEntity in such arrangements.
 * @author Erik
 * @version 2.0
...
public class SelfBilledCreditNoteEntity{
	...
	/**
	 * The buyer's accounting code, applied to the SelfBilledCreditNoteEntity as a whole,
	 * expressed as text.
	 */
