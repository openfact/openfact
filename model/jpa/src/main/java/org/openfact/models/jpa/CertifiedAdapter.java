...
public class CertifiedAdapter implements CertifiedModel, JpaModel<CertifiedEntity> {
	...
	public CertifiedAdapter(OrganizationModel organization, CertifiedEntity certified, EntityManager em,
	...
	public void setCertificate(String certificate) {
		certified.setCertificate(certificate);
	...
	public void setHasCertificate(boolean hasCertificate) {
		certified.setHasCertificate(hasCertificate);
	...
	public boolean isHasCertificate() {
		...
		return certified.isHasCertificate();
	}

	@Override
	public boolean isStatus() {		
		return certified.isEnabled();
	}
}
