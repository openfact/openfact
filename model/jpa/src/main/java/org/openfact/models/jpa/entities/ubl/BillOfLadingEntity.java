...
public class BillOfLadingEntity{
	...
	/**
	 * A code signifying the status of the BillOfLadingEntity (revision, replacement, etc.
	 * ).
	 */
	...
	/**
	 * Reference number to identify a Shipping OrderEntity or Forwarding Instruction.
	 */
