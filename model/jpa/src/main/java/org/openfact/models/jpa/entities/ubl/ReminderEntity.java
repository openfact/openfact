...
public class ReminderEntity{
	...
	/**
	 * The buyer's accounting code, applied to the ReminderEntity as a whole, expressed as
	 * text.
	 */
	...
	/**
	 * The number of the current ReminderEntity in the sequence of reminders relating to the
