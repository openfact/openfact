...
public class Consumption {
	...
	private Energy Water Supply m_Energy Water Supply;
	private Monetary Total Legal Monetary Total;
	private Period Main Period;
	private Tax Total m_Tax Total;
	private Telecommunications Supply m_Telecommunications Supply;
	...
	public Energy Water Supply getEnergy Water Supply(){
	...
	public Telecommunications Supply getTelecommunications Supply(){
	 ...
	 * @param newVal
	 */
	public void setEnergy Water Supply(Energy Water Supply newVal){
	 ...
	 * @param newVal
	 */
	public void setMain Period(Period newVal){
		Main Period = newVal;
	}
	 ...
	 * @param newVal
	 */
	public void setTelecommunications Supply(Telecommunications Supply newVal){
