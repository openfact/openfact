...
@Entity
@Table(name = "ORGANIZATION_FILE", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"ORGANIZATION_ID", "FILE_NAME"})
})
@NamedQueries({
        @NamedQuery(name = "getOrganizationFileById", query = "select f from FileEntity f where f.organization.id = :organizationId"),
