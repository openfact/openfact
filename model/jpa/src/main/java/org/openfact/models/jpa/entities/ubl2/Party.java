...
public class Party {
	...
	private Party Identification m_Party Identification;
	private Party Legal Entity m_Party Legal Entity;
	private Party Name m_Party Name;
	private Party Tax Scheme m_Party Tax Scheme;
	private Person m_Person;
	private Power Of Attorney m_Power Of Attorney;
	private Service Provider Party m_Service Provider Party;
	...
	public Party Identification getParty Identification(){
		return m_Party Identification;
	}

	public Party Legal Entity getParty Legal Entity(){
		return m_Party Legal Entity;
	}

	public Party Name getParty Name(){
		return m_Party Name;
	}

	public Party Tax Scheme getParty Tax Scheme(){
	...
	public Location getPhysical Location(){
		return Physical Location;
	}

	public Address getPostal Address(){
		return Postal Address;
	}

	public Power Of Attorney getPower Of Attorney(){
		return m_Power Of Attorney;
	}

	public Service Provider Party getService Provider Party(){
	 ...
	 * @param newVal
	 */
	public void setParty Identification(Party Identification newVal){
	 ...
	 * @param newVal
	 */
	public void setParty Legal Entity(Party Legal Entity newVal){
	 ...
	 * @param newVal
	 */
	public void setParty Name(Party Name newVal){
		m_Party Name = newVal;
	}
	 ...
	 * @param newVal
	 */
	public void setParty Tax Scheme(Party Tax Scheme newVal){
	 ...
	 * @param newVal
	 */
	public void setPhysical Location(Location newVal){
	 ...
	 * @param newVal
	 */
	public void setPostal Address(Address newVal){
	 ...
	 * @param newVal
	 */
	public void setPower Of Attorney(Power Of Attorney newVal){
	 ...
	 * @param newVal
	 */
	public void setService Provider Party(Service Provider Party newVal){
