...
public class TransportExecutionPlanRequestEntity{
	...
	/**
	 * A reason associated with the status of the TransportExecutionPlanEntity Request.
	 */
	 ...
	 * in the TransportExecutionPlanEntity Request.
	 */
	...
	/**
	 * An identifier for the current version of the TransportExecutionPlanEntity Request.
	 */
