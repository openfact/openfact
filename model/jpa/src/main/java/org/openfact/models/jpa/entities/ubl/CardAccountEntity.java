...
public class CardAccountEntity {
	 ...
	 */
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "value", column = @Column(name = "CHIPAPPLICATIONID_VALUE")),
	 ...
	 */
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "value", column = @Column(name = "PRIMARYACCOUNTNUMBERID_VALUE")),
