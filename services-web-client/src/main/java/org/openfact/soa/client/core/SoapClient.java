...
import org.openfact.soa.client.SoapClientException;
import org.openfact.soa.client.TransmissionException;
import org.openfact.soa.client.ssl.SSLUtils;
...
import static org.openfact.soa.client.core.SoapConstants.*;
...
public final class SoapClient {
	...
	/**
	 * Post the SOAP message to the SOAP server without specifying the
	 * SOAPAction
	 *
	...
	/**
	 * Disconnects from the SOAP server Underlying connection is a persistent
	...
	private void configureProxy() {
		...
		if (proxyTlsEnabled) {
			...
			// To make the HttpClient talk to a HTTP End-site through an HTTPS
			// Proxy, the route should be secure,
	...
	public static class Builder {
		...
		/**
		 * @param value
		 *            URL of the SOAP endpoint to whom the client should send
		 *            messages. Null is not accepted.
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            Specifies the timeout in millisecond for the read
		 *            operation. Has to be not negative.
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            Specifies the timeout in millisecond for the connect
		 *            operation. Has to be not negative.
		 * @return builder
		 */
