...
public class Security {
	...
	public static class Builder {
		...
		/**
		 * @param value
		 *            Specifies the instance of the truststore to use in the
		 *            SOAP communication. Null is not accepted.
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            Specifies the URL of the truststore to use in the SOAP
		 *            communication. Null is not accepted.
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            Specifies the type of the truststore. Null is not
		 *            accepted.
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            truststore password. Null is accepted.
		 * @return builder
		 */
		 ...
		 *
		 * @param value
		 *            strict host verification enables/disabled
		 * @return builder
		 */
		...
		/**
		 * @param value
		 *            Specifies the SSL Context Protocol. By default it's SSLv3.
		...
		private KeyStore initKeyStore(KeyStore keyStore, URL keyStoreUrl, String keyStoreType,
			...
			if (keyStore != null && keyStorePropertiesDefined) {
				throw new SoapClientException(
						"Specify either a keyStore | trustStore instance or properties required to load one "
								+ "(url, type, password)");
			}
			if (keyStoreUrl != null) {
				try {
