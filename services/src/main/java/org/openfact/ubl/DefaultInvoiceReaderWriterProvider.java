...
public class DefaultInvoiceReaderWriterProvider implements InvoiceReaderWriterProvider {

    protected OpenfactSession session;

    public DefaultInvoiceReaderWriterProvider(OpenfactSession session) {
