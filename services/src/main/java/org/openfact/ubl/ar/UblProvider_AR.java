...
public class UblProvider_AR implements UblProvider {

    private static final Logger log = Logger.getLogger(UblProvider_AR.class);

    protected OpenfactSession session;

    public UblProvider_AR(OpenfactSession session) {
