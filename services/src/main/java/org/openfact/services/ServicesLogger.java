...
public interface ServicesLogger extends BasicLogger {
    ...
    ServicesLogger LOGGER = Logger.getMessageLogger(ServicesLogger.class, "org.openfact.services");
    ...
    @LogMessage(level = INFO)
    @Message(id=3, value="Not importing organization %s from %s.  It already exists.")
    void organizationExists(String organizationName, String from);

    @LogMessage(level = INFO)
    @Message(id=4, value="Imported organization %s from %s.")
    void importedOrganization(String organizationName, String from);

    @LogMessage(level = WARN)
    @Message(id=5, value="Unable to import organization %s from %s.")
    void unableToImportOrganization(@Cause Throwable t, String organizationName, String from);

    @LogMessage(level = INFO)
    @Message(id=6, value="Importing invoices from '%s'")
    ...
    @LogMessage(level = INFO)
    @Message(id=31, value="Import of organization '%s' requested. Strategy: %s")
    void organizationImportRequested(String organizationName, String strategy);
    ...
    @LogMessage(level = INFO)
    @Message(id=34, value="Export of organization '%s' requested.")
    void organizationExportRequested(String organizationName);
    ...
    @LogMessage(level = INFO)
    @Message(id=50, value="Initializing %s organization")
    void initializingAdminOrganization(String adminOrganizationName);
