...
public class OrganizationsResource {
    ...
    public Object resolveOrganizationExtension(@PathParam("organization") String organizationName,
        ...
        Iterator<OrganizationResourceProvider> it = organizationResourceProviders.iterator();
        while (it.hasNext()) {
            OrganizationResourceProvider provider = (OrganizationResourceProvider) it.next();
