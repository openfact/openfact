...
public class AdminRoot {
    ...
    public Theme getTheme(OrganizationModel organization) throws IOException {        
    ...
    public Response masterOrganizationAdminConsoleRedirect() {
        OrganizationModel master = organizationManager.getOpenfactAdminstrationOrganization();
