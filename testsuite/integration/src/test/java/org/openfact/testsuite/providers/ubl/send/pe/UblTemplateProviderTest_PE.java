...
public class UblTemplateProviderTest_PE extends AbstractProviderTest {
    ...
    public void createInvoice() throws Exception {
        ...
        invoice = session.invoices().addInvoice(organization, "F001-0001");
        ...
        JAXBElement<AdditionalInformationTypeSunatAgg> jeAits = factory
    ...
    public void sendInvoice() throws Exception {
        ...
        UblTemplateProvider template = session.getProvider(UblTemplateProvider.class, LOCAL);
