...
public class SPI6 {
    ...
    public static void main(String[] args) throws IOException {
        String sourceDir = "/home/admin/git/openfact-temp/server-spi/src/main/java/org/openfact/models/ubl";
        String destinationDirEntity = "/home/admin/git/openfact-temp/server-spi/src/main/java/org/openfact/models/ubl1";
    ...
    public static void copyFolder(String sourceDir, String destinationDir) throws IOException {
        ...
        for (Path path : paths) {
            ...
            Path pathPattern = destinationPath.resolve(fileName.replaceAll("Type", "Model"));
