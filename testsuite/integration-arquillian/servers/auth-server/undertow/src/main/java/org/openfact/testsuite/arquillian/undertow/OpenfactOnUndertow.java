...
package org.openfact.testsuite.arquillian.undertow;
...
public class OpenfactOnUndertow implements DeployableContainer<OpenfactOnUndertowConfiguration> {

    protected final Logger log = Logger.getLogger(this.getClass());
    
    private UndertowJaxrsServer undertow;
    private OpenfactOnUndertowConfiguration configuration;
    private OpenfactSessionFactory sessionFactory;

    private DeploymentInfo createOpenfactServerDeploymentInfo() {
        ...
        di.addWelcomePage("theme/openfact/welcome/resources/index.html");
    ...
    @Override
    public Class<OpenfactOnUndertowConfiguration> getConfigurationClass() {
        return OpenfactOnUndertowConfiguration.class;
    }
    ...
    @Override
    public void setup(
            OpenfactOnUndertowConfiguration undertowContainerConfiguration) {
    ...
    public void start() throws LifecycleException {
        ...
        DeploymentInfo di = createOpenfactServerDeploymentInfo();
        undertow.deploy(di);
