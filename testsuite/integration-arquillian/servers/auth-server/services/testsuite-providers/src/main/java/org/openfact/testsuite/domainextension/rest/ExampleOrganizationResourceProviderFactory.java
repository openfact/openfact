...
public class ExampleOrganizationResourceProviderFactory implements OrganizationResourceProviderFactory {
    ...
    public OrganizationResourceProvider create(OpenfactSession session) {
        return new ExampleOrganizationResourceProvider(session);
    }
