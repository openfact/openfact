...
public class ExampleOrganizationResourceProvider implements OrganizationResourceProvider {

    private OpenfactSession session;

    public ExampleOrganizationResourceProvider(OpenfactSession session) {
