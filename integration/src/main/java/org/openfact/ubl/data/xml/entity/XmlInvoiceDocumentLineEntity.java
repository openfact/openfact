...
public class XmlInvoiceDocumentLineEntity {
    ...
    public BigDecimal getOf_invoiced_quantity() {
        return of_invoiced_quantity;
    }

    public void setOf_invoiced_quantity(BigDecimal of_invoiced_quantity) {
        this.of_invoiced_quantity = of_invoiced_quantity;
    }
