...
/**
 * As explained in ExceptionCriteriaModel Line: Three types of exception
 * criteria can be defined, Operational, Metric or ForecastExceptions. This
 * class provides criteria for forecast exception type: the identification of
 * the purpose of the forecast, the source
 * 
 * @author Erik
 * @version 2.1
 * @created 07-Set.-2016 9:15:16 a. m.
 */
public class ForecastExceptionModel {
