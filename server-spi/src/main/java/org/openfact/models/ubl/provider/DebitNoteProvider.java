...
public interface DebitNoteProvider extends Provider {
	...
	List<DebitNoteModel> getDebitNotes(OrganizationModel organization, List<RequeridActionDocument> requeridAction,
	...
	List<DebitNoteModel> searchForDebitNote(OrganizationModel organization, String filterText, Integer firstResult,
			Integer maxResults);
